...
/**
 * @author sr.djordjevic
 */
public class Match2 {
    // TODO: This class requires heavy refactoring. It's huge, fat and dirty
    // and, although it works, this code quality in unacceptable
    ...
    private void init() {
        ...
        remainingBudget = budget - profitEstimation();
    }
